/**
 * Motifs génératifs utilisés par la dimension « Motif ».
 *
 * Porté depuis « quad-box » (src/lib/generative.js) :
 ...
 *
 * Seule adaptation : le thème ('light' ou 'dark', comme dans le dépôt
 * d'origine) est reçu en paramètre au lieu d'être lu dans un
 * store Svelte global, pour que le module reste utilisable hors composant.
 */
...
export const createArtSvg = (seed, width = 400, height = 400, themeCourant = 'light') => {
